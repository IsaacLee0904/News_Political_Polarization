...
def main():
    ...
    for csv_file in csv_files:  
        ...
        # model_save_path = os.path.join(project_root, 'model', 'tf_idf_model', '{}'.format(df_key)) # with normal tf-idf model
        model_save_path = os.path.join(project_root, 'model', 'tf_idf_with_ngram_model', '{}'.format(df_key)) # with ngram tf-idf model
        try:
