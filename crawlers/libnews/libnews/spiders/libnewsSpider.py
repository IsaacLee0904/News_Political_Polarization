...
class LibnewsspiderSpider(scrapy.Spider):
    ...
    # start_urls = ['https://search.ltn.com.tw/list?keyword=藻礁&start_time=20041201&end_time=20230809&sort=date&type=all&sort=date']
    # start_urls = ['https://search.ltn.com.tw/list?keyword=公投綁大選&start_time=20041201&end_time=20230809&sort=date&type=all&sort=date']
    start_urls = ['https://search.ltn.com.tw/list?keyword=核四&start_time=20041201&end_time=20230809&sort=date&type=all&sort=date']
    ...
    def parse_newscontent(self, response):
        ...
        dict_item['content'] = content.replace('\n', '')
        yield dict_item
