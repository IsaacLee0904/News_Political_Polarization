...
class ChinatimesspiderSpider(scrapy.Spider):
    ...
    # page_temp_url = 'https://www.chinatimes.com/search/藻礁?page=%d&chdtv'
    # page_temp_url = 'https://www.chinatimes.com/search/公投綁大選?page=%d&chdtv'
    page_temp_url = 'https://www.chinatimes.com/search/核四?page=%d&chdtv'
    # range of pages
    cur_page = 1
    max_page = 178
    ...
    def parse(self, response):
        ...
        for sublink in level_1_list:
            ...
            URL = sublink.xpath('div/div/div/h3/a/@href' ).get()       
            title = sublink.xpath('div/div/div/h3/a/text()' ).get()   
            #/html/body/div[2]/div/div[2]/div/section/div/ul/li[4]/div/div/div[2]/div/div/a
            category = sublink.xpath('div/div/div/div/div/a/text()' ).get()    
            # /html/body/div[2]/div/div[2]/div/section/div/ul/li[4]/div/div/div[2]/div/time
            up_datetime = sublink.xpath('div/div/div/div/time/@datetime' ).get() 
